    ...
    public class OnScreenKey : Border
    {
        ...
        private readonly GradientBrush _keySurfaceBrush = new LinearGradientBrush(
            new GradientStopCollection
                {
                    new GradientStop(Color.FromArgb(250,230, 230, 230), 0),
                    //new GradientStop(Color.FromArgb(250,56, 56, 56), 0.6),
                    new GradientStop(Color.FromArgb(250,200,200, 200), 1)
                }, 90);
            ...
            _keyText = new TextBlock
                           {
                               ...
                               Foreground = new SolidColorBrush(Color.FromArgb(255,11,52,68)),
                               SnapsToDevicePixels = true
                           };
        ...
        private void AnimateMouseDown()
        {
            ...
            //action.SoundLocation = AppDomain.CurrentDomain.BaseDirectory + "\\click.wav";
            //action.Play();
        ...
        private void AnimateMouseUp()
        {
            ...
            _keyText.Foreground = new SolidColorBrush(Color.FromArgb(255, 11, 52, 68));
